...
from wav2vec_ctc_model import Wav2VecCTCModel
...
@hydra_runner(config_path="configs", config_name="wav2vecCTC")
def main(cfg):
    logging.info(f'Hydra config: {OmegaConf.to_yaml(cfg)}')

    trainer = pl.Trainer(**cfg.trainer)
    exp_manager(trainer, cfg.get("exp_manager", None))
    asr_model = Wav2VecCTCModel(cfg=cfg.model, trainer=trainer)
